...
from src.extraction.structural_parsing_service import StructuralParsingService, StageTiming
...
class ExtractionPipeline:
    ...
    def run_pipeline(self, pdf_path: str, doc_id: str, s3_bucket: str, s3_key: str) -> Dict[str, Any]:
        ...
        import time
        t0 = time.time()
        md_result = self.markdown_service.extract(parse_result.markdown, parse_result.hyperlinks)
        t1 = time.time()
